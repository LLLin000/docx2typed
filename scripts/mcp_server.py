...
_STATIC_CAPABILITIES: list[dict[str, Any]] = [
    ...
    {"capability": "word.foreign-edit.media-add", "support": "supported", "guard": "one target-owned PNG drawing addition with its new relationship and content type; existing media, retargets, id reuse, lost parts, and other package changes refuse", "tools": ["foreign_edit_prepare", "foreign_edit_adopt"], "notes": "bounded package owner inside the foreign adoption gate"},
